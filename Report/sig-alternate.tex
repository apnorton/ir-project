...
A particular weakness of our system is that it focuses onmathematical expressions to the complete exclusion
...
Although the author of the Cowpie project provided the grammar used to parse the \LaTeX, we used an alternate system
...
%I'd like to thank the based god.
