...
# This class defines a complete listener for a parse tree produced by LatexGramParser.
class LatexGramListener(ParseTreeListener):

    # Enter a parse tree produced by LatexGramParser#s.
    def enterS(self, ctx):
        pass

    # Exit a parse tree produced by LatexGramParser#s.
    def exitS(self, ctx):
        pass
